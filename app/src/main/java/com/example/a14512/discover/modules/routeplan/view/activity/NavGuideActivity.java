...
public class NavGuideActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoGuideActivity.activityList.add(this);
        createHandler();
        View view = null;
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(GoGuideActivity.ROUTE_PLAN_NODE);
            }
        }
        //显示自定义图标
        if (hd != null) {
    ...
    protected void onDestroy() {
        ...
        GoGuideActivity.activityList.remove(this);
    }
